...
var token_management_js_1 = require("../midlleware/token-management.js");
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                return [4 /*yield*/, database_js_1.pool.query('SELECT * FROM users WHERE login=$1', [login])]; // on récupère le user dans la BD
            case 1:
...
router.get('/me', token_management_js_1.verifyToken, function (req, res) {
