...
router.get('/', function (_req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, database_js_1.pool.query('SELECT id, login, role FROM users')];
            case 1:
                rows = (_a.sent()).rows;
                res.json(rows);
                return [2 /*return*/];
...
router.post('/', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 2:
                hash = _b.sent();
                return [4 /*yield*/, database_js_1.pool.query('INSERT INTO users (login, password_hash) VALUES ($1, $2)', [login, hash])];
            case 3:
                _b.sent();
